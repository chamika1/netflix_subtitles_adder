// Netflix Sinhala Subtitles Extension - Content Script
...
class NetflixSubtitleManager {
  ...
  init() {
    console.log('Netflix Sinhala Subtitles: Initializing...');
    this.waitForVideo();
  ...
  waitForVideo() {
    const checkVideo = setInterval(() => {
      ...
      if (this.video) {
        console.log('Netflix Sinhala Subtitles: Video element found');
  ...
  handleFullscreenChange() {
    ...
    console.log('Netflix Sinhala Subtitles: Fullscreen change detected, isFullscreen:', isFullscreen);
  ...
  async loadSubtitleFile(file) {
    try {
      ...
      if (this.subtitles.length > 0) {
        this.isActive = true;
        this.showNotification('Sinhala subtitles loaded successfully! ✅');
